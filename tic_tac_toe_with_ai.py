...
def main():
    print('Tic tac toe')
    print('Player is X and goes first.')
    printBoard(board)
    ...
    while not (isBoardFull(board)):
        ...
        if not (isWinner(board, 'X')):
            ...
            if move == 0:
                ...
                insertLetter('O', move)
                print('Computer placed an \'O\' in psotion', move, ':')
                printBoard(board)
        else:
